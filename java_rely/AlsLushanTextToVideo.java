 ...
 * */
public class AlsLushanTextToVideo 
{
    static final String NAME = "AlsLushanTextToVideo";
    ...
    public static void main(String[] args) throws Exception{
        ...
        job.setJobName("AlsLushanTextToVideo");
        job.setJarByClass(AlsLushanTextToVideo.class);   
     
        MultipleInputs.addInputPath(job, new Path(otherArgs[0]),
            TextInputFormat.class, datamining.als.AlsLushanTextToVideo.InputMap.class);
